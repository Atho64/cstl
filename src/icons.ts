// @module icons.ts — Lucide SVG icons (inline, no CDN needed)
...
const PATHS: Record<IconName, string> = {
  ...
  'restore': '<path d="M21 12a9 9 0 1 1-3-6.7" /><path d="M21 3v5h-5" />',
  'arrow-right': '<path d="M5 12h14" /><path d="m12 5 7 7-7 7" />',
  'clock': '<circle cx="12" cy="12" r="10" /><polyline points="12 6 12 12 16 14" />',
  'file-text': '<path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z" /><path d="M14 2v4a2 2 0 0 0 2 2h4" /><path d="M10 13h4" /><path d="M10 17h4" />',
...
/** Return SVG string for an icon. Size defaults to 24. */
export function icon(name: IconName, size?: number, extraClass = ''): string {
  const s = size || 24;
